    ...
    >
      ...
      ">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-base sm:text-lg leading-relaxed select-none">
            <li>{t.spec1}</li>
            <li>{t.spec2}</li>
            <li>{t.spec3}</li>
            <li>{t.spec4}</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-1 text-base sm:text-lg leading-relaxed select-none">
            <li>{t.app1}</li>
            <li>{t.app2}</li>
            <li>{t.app3}</li>
            <li>{t.app4}</li>
